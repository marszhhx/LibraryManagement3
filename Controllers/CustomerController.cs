...
using LibraryManagement3.Models;
using LibraryManagement3.ViewModels;

namespace LibraryManagement.Controllers
{
    public class CustomerController : Controller
    {
        private readonly ApplicationDbContext _dbContext; // Assuming AppDbContext is your database context class
